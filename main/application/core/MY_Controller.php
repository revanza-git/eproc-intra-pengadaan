	...
	*/
	...
	public function send_mail($to, $subject, $message, $link="#",$type=''){	
		...
		$config = Array(
			...
			'smtp_host' => env('EMAIL_PERTAMINA_SMTP_HOST', 'mail.pertamina.com'),
			'smtp_port' => env('EMAIL_PERTAMINA_SMTP_PORT', 25),
			'smtp_user' => env('EMAIL_PERTAMINA_SMTP_USER', 'portal.nr@pertamina.com'),
			'smtp_pass' => env('EMAIL_PERTAMINA_SMTP_PASSWORD', 'PGE@Wm8iltpi1'),
			'mailtype'  => 'html', 
			'charset'   => 'utf-8',
		...
		$this->email->from(env('EMAIL_PERTAMINA_FROM_ADDRESS', 'portal.nr@pertamina.com'), env('EMAIL_PERTAMINA_FROM_NAME', 'E-Proc Nusantara Regas'));
