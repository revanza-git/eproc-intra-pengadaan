...
$config['base_app']	= 	env('PENGADAAN_BASE_APP', 'http://local.eproc.intra.com/pengadaan/');
$config['base_url'] = env('PENGADAAN_BASE_URL', 'http://local.eproc.intra.com/pengadaan/');
$config['vms_url'] = env('PENGADAAN_VMS_URL', 'http://local.eproc.vms.com/');
$config['pengadaan_url'] = env('PENGADAAN_BASE_URL', 'http://local.eproc.intra.com/pengadaan/');
